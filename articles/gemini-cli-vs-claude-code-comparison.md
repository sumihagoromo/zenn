...
- Claude Pro/Max の有料プラン加入でCLI利用権が含まれる
...
- 初期リリース時の自動更新機能バグは迅速に対応
- ソースコードは公開済みだが商用利用を制限する独自ライセンス
